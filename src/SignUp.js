...
const UserRegistration = data => {
  ...
  return axios.post(`http://${process.env.REACT_APP_BASEURI}/login/signup`, data)
      .then(res => res.status);
};

//User Vaidation service connect express login/user route to check user entered data 
export const UserValidation = data => (
  axios.post(`http://${process.env.REACT_APP_BASEURI}/login/user`, data)
...
export const EmailValidation = data => (
  axios.post(`http://${process.env.REACT_APP_BASEURI}/login/emailcheck`, data)
  .then(exist => exist.status)
)
